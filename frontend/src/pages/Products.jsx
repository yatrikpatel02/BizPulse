...
export default function Products() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filters / Search Bar */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-navy-800/60 backdrop-blur-md border border-white/[0.06] rounded-2xl p-4 shadow-sm">
        {/* Search */}
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-navy-900/40 bg-navy-900/40 border border-white/[0.06] focus-glow focus:bg-navy-800 rounded-xl text-sm transition-all duration-300 outline-none text-white"
          />
        </div>

        {/* Filter Buttons */}
        <div className="flex items-center gap-1.5 bg-navy-900/40 border border-white/[0.06] p-1.5 rounded-xl self-start md:self-center">
            ...
            <table className="w-full text-left border-collapse">
               <thead>
                 <tr className="border-b border-white/[0.06] bg-navy-900/40 bg-navy-800/60/50">
                   <th className="px-6 py-4 text-xs font-bold text-slate-200 uppercase tracking-wider">Product Name</th>
                   <th className="px-6 py-4 text-xs font-bold text-slate-200 uppercase tracking-wider">SKU</th>
                   <th className="px-6 py-4 text-xs font-bold text-slate-200 uppercase tracking-wider">Price</th>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          className="p-1.5 text-slate-500 hover:text-indigo-600 text-slate-400 dark:hover:text-violet-400 hover:bg-violet-500/10 rounded-lg transition-all duration-200"
                          title="Edit Product"
                        >
                          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="w-full max-w-lg bg-navy-800/60 glass-card rounded-2xl p-6 shadow-glass-lg space-y-4 animate-scale-up">
            ...
            {formError && (
              <div className="p-3 text-xs font-semibold text-red-600 text-red-400 bg-red-500/10 border border-red-500/20 rounded-xl">
                {formError}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-navy-900/40 bg-navy-900/40 border border-white/[0.06] focus-glow focus:bg-navy-800 rounded-xl text-sm transition-all duration-200 outline-none text-white"
                  required
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 bg-navy-900/40 bg-navy-900/40 border border-white/[0.06] focus-glow focus:bg-navy-800 rounded-xl text-sm transition-all duration-200 outline-none text-white resize-none"
                />
              </div>
              ...
              <div className="flex items-center gap-3 pt-2">
                <input
                  ...
                  onChange={handleChange}
                  className="w-4.5 h-4.5 text-indigo-600 border-white/[0.08] rounded focus:ring-violet-500 cursor-pointer"
                />
                <label htmlFor="is_active" className="text-sm font-semibold text-slate-300 cursor-pointer">
