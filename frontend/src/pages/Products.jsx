...
export default function Products() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filters / Search Bar */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 glass-card backdrop-blur-md border border-slate-200 dark:border-slate-200 dark:border-white/[0.06] rounded-2xl p-4 shadow-sm">
        {/* Search */}
        ...
        {/* Filter Buttons */}
        <div className="flex items-center gap-1.5 glass-surface border border-slate-200 dark:border-slate-200 dark:border-white/[0.06] p-1.5 rounded-xl self-start md:self-center">
      ...
      <div className="glass-card backdrop-blur-md border border-slate-200 dark:border-slate-200 dark:border-white/[0.06] rounded-2xl shadow-md overflow-hidden">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h4 className="text-lg font-bold text-slate-650 dark:text-slate-650 dark:text-slate-300">No products found</h4>
              ...
              <tbody className="divide-y divide-slate-150 dark:divide-slate-150 dark:divide-slate-150 dark:divide-white/[0.04]">
                {filteredProducts.map((product) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 font-mono text-xs text-slate-650 dark:text-slate-650 dark:text-slate-300">
                      {product.sku || '—'}
                    </td>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="w-full max-w-lg glass-card glass-card rounded-2xl p-6 shadow-glass-lg space-y-4 animate-scale-up">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                />
                <label htmlFor="is_active" className="text-sm font-semibold text-slate-650 dark:text-slate-650 dark:text-slate-300 cursor-pointer">
