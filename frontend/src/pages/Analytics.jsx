...
export default function Analytics() {
  ...
  return (
    <div className="space-y-6 pb-12 transition-all duration-300">
      ...
      <div className="sticky top-0 z-20 bg-navy-950/90 backdrop-blur-md pb-3 pt-1 flex flex-col gap-3 transition-all duration-200">
        {/* 1. Sleek Tab Navigation */}
        <div className="flex p-1 bg-navy-900/60 backdrop-blur-md border border-white/[0.06] rounded-xl w-full overflow-x-auto gap-1">
          {[
