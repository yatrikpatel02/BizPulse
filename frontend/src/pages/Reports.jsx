...
export default function Reports() {
  ...
  const renderSalesSection = (sales) => {
    ...
    return (
      <div className="space-y-3">
        <h5 className="font-bold text-slate-200">📊 Sales Performance</h5>
  ...
  const renderInventorySection = (inv) => {
    ...
    return (
      <div className="space-y-3">
        <h5 className="font-bold text-slate-200">📦 Inventory Health</h5>
        <div className="grid grid-cols-2 gap-3">
          <div className="p-3 bg-navy-800/60 border border-white/[0.04] border-white/[0.06] rounded-xl">
  ...
  const renderCustomerSection = (cust) => {
    ...
    return (
      <div className="space-y-3">
        <h5 className="font-bold text-slate-200">💬 Customer Feedback Intelligence</h5>
        <div className="grid grid-cols-2 gap-3">
          <div className="p-3 bg-navy-800/60 border border-white/[0.04] border-white/[0.06] rounded-xl">
  ...
  const renderMarketSection = (market) => {
    ...
    return (
      <div className="space-y-3">
        <h5 className="font-bold text-slate-200">📈 Market Trend Insights</h5>
        {insights.length === 0 ? (
  ...
  return (
    <div className="space-y-6">
      ...
      {reportViewer && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="w-full max-w-3xl bg-navy-800/60 glass-card rounded-2xl p-6 shadow-glass-lg space-y-4 animate-scale-up max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
            <div className="flex items-center justify-between border-b border-white/[0.06] pb-3">
              <h3 className="text-xl font-bold text-slate-800 dark:text-white font-display capitalize flex items-center gap-2">
