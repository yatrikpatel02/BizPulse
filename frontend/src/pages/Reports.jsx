...
export default function Reports() {
  ...
  const renderSalesSection = (sales) => {
    ...
    return (
      <div className="space-y-3 report-section">
        <h5 className="font-bold text-gray-800 dark:text-slate-700 dark:text-slate-700 dark:text-slate-200">📊 Sales Performance</h5>
        ...
        {products.length > 0 && (
          <div>
            <h6 className="text-xs font-bold text-slate-500 dark:text-slate-500 dark:text-slate-400 uppercase mt-3 mb-2">Top Selling Products</h6>
  ...
  const renderInventorySection = (inv) => {
    ...
    return (
      <div className="space-y-3 report-section">
        <h5 className="font-bold text-gray-800 dark:text-slate-700 dark:text-slate-700 dark:text-slate-200">📦 Inventory Health</h5>
        <div className="grid grid-cols-2 gap-3">
          <div className="p-3 glass-card border border-slate-200/50 dark:border-slate-200/50 dark:border-white/[0.04] border-slate-200 dark:border-slate-200 dark:border-white/[0.06] rounded-xl">
  ...
  const renderCustomerSection = (cust) => {
    ...
    return (
      <div className="space-y-3 report-section">
        <h5 className="font-bold text-gray-800 dark:text-slate-700 dark:text-slate-700 dark:text-slate-200">💬 Customer Feedback Intelligence</h5>
        <div className="grid grid-cols-2 gap-3">
          <div className="p-3 glass-card border border-slate-200/50 dark:border-slate-200/50 dark:border-white/[0.04] border-slate-200 dark:border-slate-200 dark:border-white/[0.06] rounded-xl">
        ...
        {Object.keys(sentiments).length > 0 && (
          <div>
            <h6 className="text-xs font-bold text-slate-500 dark:text-slate-500 dark:text-slate-400 uppercase mt-3 mb-2">Sentiment Distribution</h6>
              ...
              {Object.entries(sentiments).map(([key, val]) => {
                ...
                return (
                  <span key={key} className={`px-2.5 py-1 rounded-lg text-xs font-bold border ${
                    ...
                    'glass-surface text-slate-500 dark:text-slate-500 dark:text-slate-400 border-slate-200 dark:border-slate-200 dark:border-white/[0.06]/40'
                  }`}>
  ...
  const renderMarketSection = (market) => {
    ...
    return (
      <div className="space-y-3 report-section">
        <h5 className="font-bold text-gray-800 dark:text-slate-700 dark:text-slate-700 dark:text-slate-200">📈 Market Trend Insights</h5>
        {insights.length === 0 ? (
              ...
              <div key={i} className="p-3 glass-card border border-slate-200/50 dark:border-slate-200/50 dark:border-white/[0.04] border-slate-200 dark:border-slate-200 dark:border-white/[0.06] rounded-xl">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-xs font-bold px-2 py-0.5 rounded-full ${
                    ...
                    'bg-gray-100 text-slate-500 dark:text-slate-500 dark:text-slate-400'
                  }`}>{ins.insight_type}</span>
                </div>
                <p className="text-xs text-slate-500 dark:text-slate-500 dark:text-slate-400 mt-1">{ins.recommendation || ins.description || ''}</p>
                {ins.pct_change != null && (
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-slate-200 dark:border-slate-200 dark:border-white/[0.06] glass-surface glass-card/50">
                    <th className="px-6 py-4 text-xs font-bold text-slate-700 dark:text-slate-700 dark:text-slate-200 uppercase tracking-wider">Report Type</th>
                    <th className="px-6 py-4 text-xs font-bold text-slate-700 dark:text-slate-700 dark:text-slate-200 uppercase tracking-wider">Generated Date</th>
          ...
          <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-3xl p-6 shadow-2xl space-y-4 animate-scale-up">
            ...
            <form onSubmit={handleGenerate} className="space-y-4">
              <div className="space-y-1">
                <label className="text-xs font-bold text-slate-500 dark:text-slate-500 dark:text-slate-400 uppercase tracking-wide">Start Date</label>
                <input
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-slate-500 dark:text-slate-500 dark:text-slate-400 uppercase tracking-wide">End Date</label>
                <input
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-slate-500 dark:text-slate-500 dark:text-slate-400 uppercase tracking-wide">Export Format</label>
                <select
