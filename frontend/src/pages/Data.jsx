...
export default function Data() {
  ...
  return (
    <div className="py-6 space-y-6">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-slate-100">Data Management</h1>
        <p className="text-gray-600 dark:text-slate-400">Import your business data to generate insights.</p>
      </div>
