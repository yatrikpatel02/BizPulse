    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h4 className="text-lg font-bold text-slate-700 dark:text-slate-300">All Clear! No alerts found</h4>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <button
                      ...
                      className="p-1 text-slate-500 hover:text-slate-500 dark:text-slate-400 dark:hover:text-slate-700 dark:text-slate-300 rounded-lg hover:glass-surface dark:hover:bg-slate-800 transition-colors self-start"
                  ...
                  {/* Body Text Sections */}
                  <div className="space-y-3 pt-2 text-xs leading-relaxed text-slate-700 dark:text-slate-300">
                    {/* Problem */}
                    {parsed.problem && (
                      <div>
                        <span className="font-bold text-[10px] text-slate-500 uppercase tracking-wide block mb-0.5">Problem</span>
                        <p className="font-semibold text-slate-700 dark:text-slate-200">{parsed.problem}</p>
                      </div>
                    )}
                    ...
                    {parsed.recommendation && (
                      <div className="p-3.5 bg-violet-500/[0.07] border border-violet-500/10 rounded-xl">
                        ...
                        <p className="font-medium text-slate-700 dark:text-slate-200">{parsed.recommendation}</p>
                      </div>
                    )}
                  </div>
                </div>
          ...
          <div className="w-full max-w-md glass-card glass-card rounded-2xl p-6 shadow-glass-lg space-y-4 animate-scale-up">
            ...
            <div className="space-y-3.5">
              <div>
                ...
                <p className="font-semibold text-slate-700 dark:text-slate-200 text-sm">{actionModal.title}</p>
              </div>

              <div>
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wide block mb-1">Action Plan</span>
                <p className="text-xs leading-relaxed text-slate-700 dark:text-slate-300 p-3 bg-slate-50 dark:bg-navy-900/40 rounded-xl border border-slate-200 dark:border-white/[0.06]">
