...
export default function SuccessStep({ tempFileId, sourceType, mapping, originalFilename, onReset }) {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-navy-800/60 bg-navy-800/60 rounded-xl shadow-sm border border-white/[0.06] p-12 text-center">
      {status === 'processing' && (
        <>
          ...
          <h2 className="text-2xl font-bold text-white text-white mb-2">Importing Your Data...</h2>
          <p className="text-slate-500 text-slate-400">Please wait while we save these records to your database. This might take a few moments.</p>
        </>
      )}
      ...
      {status === 'success' && (
        <>
          ...
          <h2 className="text-2xl font-bold text-white text-white mb-2">Import Successful!</h2>
          <p className="text-slate-500 text-slate-400 mb-6">
      ...
      {status === 'error' && (
        <>
          ...
          <h2 className="text-2xl font-bold text-white text-white mb-2">Import Failed</h2>
